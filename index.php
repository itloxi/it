...
<html lang="en">
	<head>
		...
		<title><?php if (isset($_GET['article'])) { echo $matches[1]; } else { ?> bellezza <?php } ?></title>
        <meta name="description" content="Salute che amiamo!">
		<!-- Google font -->
				...
				<div class="row">
					<div class="col-md-5">
						<div class="footer-widget">
							...
							<ul class="footer-nav">
								<li><a href="./?a=4">Politica sulla privacy</a></li>
                                <li><a href="./?a=5">Termini e condizioni</a></li>
							</ul>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved
					...
					<div class="col-md-4">
						<div class="row">
							<div class="col-md-12">
								<div class="footer-widget">
									<h3 class="footer-title">Articoli</h3>
					...
					<div class="col-md-3">
						<div class="footer-widget">
							<h3 class="footer-title">Condividere sociale. network</h3>
